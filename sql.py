...
class Login:
    ...
    def loginform(self):
        ...
        self.img=ImageTk.PhotoImage(file="foode.png")
        ...
        btn2=Button(frame_input,text="Login",command=self.login,cursor="hand2",font=('times new roman',15),bg='orangered',fg='white',bd=0,width=15,height=1)
        btn2.place(x=90,y=340)
        btn3=Button(frame_input,command=self.Register,text="or Registered?register",cursor="hand2",font=('calbri',10),bg='white',fg='black',bd=0)
    ...
    def login(self):
        if self.email_txt.get()=="" or self.password.get()=="":
            ...
            try:
                ...
                messagebox.showerror('Error',f'Errpr Due to : {str(es)}',parent=self.root)

    def Register(self):
        Frame_login1=Frame(self.root,bg="white")
        Frame_login1.place(x=0,y=0,height=700,width=1366)
        self.img=ImageTk.PhotoImage(file="food16.jpg")
        ...
        btn2=Button(frame_input2,command=self.register,text="Register",cursor="hand2",font=('times new roman',15),bg='orangered',fg='white',bd=0,width=15,height=1)
        btn2.place(x=90,y=340)
        ...
        btn3.place(x=110,y=390)
    def register(self):
        if self.entry.get()==""or self.entry2.get()==""or self.entry3.get()==""or self.entry4=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
            ...
            try:
                ...
                if row!=None:
                    ...
                    con.commit()
                    con.close()
                    messagebox.showerror('Success','Register Succesfull',parent=self.root)
                    self.loginform()
            except Exception as es:
                messagebox.showerror('Error',f'Errpr Due to : {str(es)}',parent=self.root)
    def appscreen(self):
        ...
        label3=Label(Frame_login,text="Youtube channel.If you are New to Channel",font=('times new roman',32,'bold'),fg="black",bg='white')
        label3.place(x=340,y=220)
        btn2=Button(Frame_login,command=self.loginform,text="Logout",cursor="hand2",font=('times new roman',15),bg='orangered',fg='white',bd=0,width=15,height=1)
